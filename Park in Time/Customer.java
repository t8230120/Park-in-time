...
public class Customer extends User {
        ...
        do {
            ...
            switch (choice) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    cancelParking(scanner);
                    break;
                case 6:
                    checkActiveParking(scanner);
                    break;
                case 7:
    ...
    public static void reserveParking(Scanner scanner) {
    ...
    public static void cancelParking(Scanner scanner) {
        ...
        String checkQuery = "SELECT reservation_id FROM Reservation WHERE reservation_id = " + reservationId + " AND is_active = TRUE";
        String updateQuery = "UPDATE Reservation SET is_active = FALSE WHERE reservation_id = " + reservationId;
    ...
    public static void checkActiveParking(Scanner scanner) {
